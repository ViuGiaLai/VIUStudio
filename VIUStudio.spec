...
a = Analysis(
    ...
    hiddenimports=[
        ...
        "app.runtime_paths",
        "services.timeline_video_sequence",
        "app.services.timeline_video_sequence",
        "app.layers",
        "app.layers.base",
        "app.layers.audio",
        "app.layers.video",
        "app.layers.timeline",
        "app.layers.transform",
        "app.layers.text",
        "app.layers.text_renderer",
        "app.layers.image",
        "app.layers.subtitle",
        "app.layers.dub_subtitle",
        "app.layers.blur",
        "app.layers.mask",
        "app.layers.sticker",
        "app.layers.keyframe",
        "app.layers.sync_bridge",
        "runtime_profile",
        # OCR engine
        "rapidocr",
        "sherpa_onnx",
